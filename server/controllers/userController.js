...
exports.getProfile = async (req, res) => {
  try {
    ...
    logger.error(
      `Error fetching profile for user ID ${req.userId}: ${error.message}`
    );
    res
      .status(500)
...
exports.updateProfile = async (req, res) => {
  try {
    ...
    logger.error(
      `Error updating profile for user ID ${req.userId}: ${error.message}`
    );
    res
      .status(500)
...
exports.requestPasswordReset = async (req, res) => {
  try {
    ...
    res
      .status(500)
      .json({
        message: "Something went wrong while processing password reset request",
      });
  }
};
